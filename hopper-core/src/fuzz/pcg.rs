...
//!
//! https://rust-random.github.io/rand/rand_pcg/index.html
//! https://www.pcg-random.org/
//! https://users.rust-lang.org/t/saving-and-restoring-the-state-of-a-seedablerng/52642
...
/// correlated.
#[derive(Clone, PartialEq, Eq, Serde)]
...
impl fmt::Debug for Lcg64Xsh32 {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "Lcg64Xsh32 {{ state: {}, increment: {} }}", self.state, self.increment)
    }
}
